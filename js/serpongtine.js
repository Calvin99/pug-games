...
var current = 0;
var activateR = false;
var rainbow = ['#ff0000', '#ff8800', '#ffff00', '#00ff22', '#0099ff', '#0000ff', '#ff00ff'];
    ...
    **/
        ...
        */
        ...
        if (activateR === true) {
            ...
            tC = current;
            head1.color = rainbow[hC];
            tail1.color = rainbow[tC];

            head2.color = rainbow[hC];
            tail2.color = rainbow[tC];
        }
        if (border < 0.5) {
            border -= 0.5;
        }
